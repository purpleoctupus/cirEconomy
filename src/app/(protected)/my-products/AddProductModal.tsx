...
import { AddProductSchema, AddProductSchemaType } from "../../(auth)/utils/validationSchemas";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20">
      <div className="bg-white w-full max-w-md mx-2 rounded-xl shadow-lg p-6 relative animate-fade-in my-8">
        ...
        <form className="space-y-4" onSubmit={handleSubmit(handleFormSubmit)}>
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white py-3 rounded-md hover:bg-green-700 transition-all font-medium"
          >
            Guardar producto
          </button>
        </form>
